...
CREATE TABLE `Bookings` (
  ...
  `status` enum('Confirmed','CheckedIn','CheckedOut','Completed','Cancelled') NOT NULL DEFAULT 'Confirmed',
  `createdAt` datetime NOT NULL DEFAULT current_timestamp(),
  `updatedAt` datetime NOT NULL DEFAULT current_timestamp(),
  `booked_seats` int(10) UNSIGNED DEFAULT 1 COMMENT 'Số chỗ thực tế đã đặt cho lượt booking này'
...
INSERT INTO `Bookings` (`id`, `room_id`, `mssv`, `Day`, `start_time`, `end_time`, `status`, `createdAt`, `updatedAt`, `booked_seats`) VALUES
(5, 1, '2211316', '2024-01-19', '14:00:00', '15:30:00', 'Cancelled', '2025-04-17 14:08:42', '2025-04-17 14:08:42', 5),
(13, 4, '2211316', '2025-05-03', '20:10:42', '22:10:42', 'Completed', '2025-05-03 20:10:42', '2025-05-03 20:10:42', 6),
(14, 2, '2211316', '2025-05-03', '20:28:13', '21:28:13', 'Completed', '2025-05-03 20:28:13', '2025-05-03 20:28:13', 1),
(15, 4, '2211316', '2025-05-03', '20:28:18', '22:28:18', 'Completed', '2025-05-03 20:28:18', '2025-05-03 20:28:18', 6),
(16, 3, '2211316', '2025-05-03', '20:54:38', '21:54:38', 'Completed', '2025-05-03 20:54:38', '2025-05-03 20:54:38', 1),
(17, 2, '2211316', '2025-05-03', '20:59:34', '21:59:34', 'Completed', '2025-05-03 20:59:34', '2025-05-03 20:59:34', 1),
(18, 3, '2211316', '2025-05-03', '21:10:06', '22:10:06', 'Completed', '2025-05-03 21:10:06', '2025-05-03 21:10:06', 1);
...
CREATE TABLE `Feedbacks` (
  ...
  `mssv` varchar(20) NOT NULL,
  `room_id` int(11) DEFAULT NULL COMMENT 'Reference to the room the feedback is about',
...
CREATE TABLE `Rooms` (
  ...
  `available_seats` int(11) DEFAULT NULL COMMENT 'Số chỗ hiện còn trống',
  `room_type` enum('single','group') NOT NULL DEFAULT 'group' COMMENT 'Loại phòng: đơn hoặc nhóm',
...
(6, '2211316', 'Thiết bị hư', 'Máy lạnh không hoạt động', 'Phòng 204 bị nóng, máy lạnh không hoạt động từ sáng.', '20521456@hcmut.edu.vn', '2025-04-21 10:18:03', 'Resolved', '2025-04-21 10:18:03', '2025-04-21 10:19:07');
...
('2211316', 'phan hoàng huynh', 'huynh.phan0210cm@hcmut.edu.vn', '$2b$10$y2QYUi5VSyZ43GWeXf4HX.SuAyVabSefEx2vjTJ6xX1jqnDjpbg3.', '0948637841', 'M', 'Student', '2025-04-14 22:07:36', '2025-04-14 22:07:36', 'Online'),
('2214444', 'Phan Hoàng Huynh', 'huynhcse0210@gmail.com', '$2b$10$GX8iMhXgmB0hWdrCfop1h.AtT8DghYOtFeSATSfRN2Fb03QGcsgSG', '0948637844', 'F', 'Admin_IT', '2025-05-03 23:25:41', '2025-05-03 23:25:41', 'Offline'),
